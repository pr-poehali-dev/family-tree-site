      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-24 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-200 mb-4">Современное решение для управления данными между сервисами</p>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-lg md:text-xl font-bold text-slate-900 leading-tight">Высокая производительность</h3>
              </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-lg md:text-xl font-bold text-slate-900 leading-tight">Безопасность</h3>
              </div>
              <p className="text-slate-600">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-lg md:text-xl font-bold text-slate-900 leading-tight">Гибкая настройка</h3>
              </div>
              <p className="text-slate-600">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-lg md:text-xl font-bold text-slate-900 leading-tight">Мониторинг</h3>
              </div>
              <p className="text-slate-600">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-lg md:text-xl font-bold text-slate-900 leading-tight">Масштабируемость</h3>
              </div>
              <p className="text-slate-600">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-lg md:text-xl font-bold text-slate-900 leading-tight">API первого класса</h3>
              </div>
              <p className="text-slate-600">
